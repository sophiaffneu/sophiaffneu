...
public class TextViewTest {
  ...
  public void setup() {
    ...
    ITransformation scaleR1 = new Scale(copyR, new TimePeriod(51, 70), new ShapeProperty(25, 100));
    ...
    ITransformation color1 = new ChangeColor(copyC, new TimePeriod(50, 80), new Color(0, 255, 0));
