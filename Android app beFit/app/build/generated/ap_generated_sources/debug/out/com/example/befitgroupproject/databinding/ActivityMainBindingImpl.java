...
public class ActivityMainBindingImpl extends ActivityMainBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.button_login, 1);
        sViewsWithIds.put(R.id.button_login2, 2);
        sViewsWithIds.put(R.id.linearLayout4, 3);
        sViewsWithIds.put(R.id.editTextTextPersonName, 4);
        sViewsWithIds.put(R.id.editTextDate, 5);
        ...
        sViewsWithIds.put(R.id.editTextTextPersonName6, 10);
        sViewsWithIds.put(R.id.editTextTextPersonName7, 11);
        sViewsWithIds.put(R.id.button4, 12);
        sViewsWithIds.put(R.id.textView27, 13);
        sViewsWithIds.put(R.id.editTextTextPersonName3, 14);
        sViewsWithIds.put(R.id.editTextTextPersonName4, 15);
        sViewsWithIds.put(R.id.guideline8, 16);
